...
#ifndef __itkDTIReconImageFilter_hxx_
#define __itkDTIReconImageFilter_hxx_
...
DTIReconImageFilter< TDiffusionModelCalculator, TImageDimension >
::DTIReconImageFilter()
{
...
::BeforeThreadedGenerateData()
{
  ...
  itkDebugMacro( "DTIReconImageFilter::BeforeThreadedGenerateData ")
  ...
  itkDebugMacro( "DTIReconImageFilter::BeforeThreadedGenerateData done")
}
                       ...
                       ThreadIdType threadId)
{
  ...
  itkDebugMacro( "DTIReconImageFilter::ThreadedGenerateData Begin")
  ...
  const bool forceSPD = this->GetForceTensorsToSPD();
  ...
  while( !git.IsAtEnd() )
  {
    ...
    pixValue = dtCalc->ComputeTensor(dwi,forceSPD);
  ...
  itkDebugMacro( "DTIReconImageFilter::ThreadedGenerateData done")
}
